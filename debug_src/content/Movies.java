...
public class Movies{
  ...
  MyMovies database = new MyMovies();
    ...
    public Movies(String title, String genre, String language, String plot,
        ...
        cast = database.getCastForMovie(id_nr);
    ...
    */
    ...
    /*
    public String cast(ResultSet rs){
      String movie_cast = "";
      while (rs.next()) {
        movie_cast = movie_cast + rs.getString("Name") + " - " + rs.getString("CharacterName") + "\n";
      }
      return movie_cast;
    }
    */
    ...
    public void addActorToCast(Actors a, String character_name){
    ...
    public String toString(){
      ...
      + "Written by: " + scriptwriter + "\n" + "Release: " + release_dates +
       "\n" + "Age Limit: " + age_limit + "\n" + "ID Nr.: " + id_nr + "\n" + "Cast: " + (cast.length()>0?cast:"None listed") + "------";
/*
      return "Title: " + title + "\n" + "Production year: " + year + "\n" + "Genre: " + genre + "\n" +
      "Language: " + language + "\n" + "Plot: " + plot + "\n" + "Directed by: " + director + "\n"
      + "Written by: " + scriptwriter + "\n" + "Release: " + release_dates +
